...
class VoronoiGenerator:
    ...
    def plot_voronoi(self, show_original=False):
        ...
        for i, region_index in enumerate(self.vor.point_region[:len(self.points)]):  # Only process original points
    ...
    def auto_lloyd(self):
        ...
        tolerance = 1e-3
        max_iter = 100
        previous_points = self.points.copy()
        ...
        for _ in range(max_iter):
            ...
            movement = np.linalg.norm(previous_points - centroids)

            if movement < tolerance:
                break

            previous_points = centroids.copy()
    ...
    def calculate_centroids(self):
        """Compute centroids for the original points only"""
